module Http.Request (Method(..), Query(..), Form, FormFile, Request, encodeUri, emptyReq, onCloseReq, parseQuery, getQueryField, getFormFiles, getFormField, setForm, setBody) where
...
setBody : Request -> Task a Request
setBody =
    Native.Http.setBody
